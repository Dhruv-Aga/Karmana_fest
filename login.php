       ...
       <header class="section background-image text-center" style="background-image:url(img/img-05.jpg)">
        ...
        <section class="section background-dark">
          <div class="s-12 m-12 l-4 center">
            ...
            <form class="customform text-white" method="post" action="login.php" enctype="multipart/form-data">
              ...
              <input name="email"  placeholder="E-mail" title="Your Email" type="email" required />
				...
				<?php
					if(isset($_POST['login']))
					{
					   ...
					   $verify = "select * from userdata where email='$email' && password='$pass'";
					   $exec=$conn->query($verify);
					   
					   if($exec->num_rows>0)
					   {
						      
						   $get_id="Select firstname,reg_id from userdata where email='$email' && password='$pass'";
				...
				<p align="center"><a href="reset.php">Forgot Password?</a></p>
              </div>    
            </form>
          </div>           
        </section>
